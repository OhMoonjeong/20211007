...
public class OrderDAOOracle implements OrderDAOInterface {
	private static OrderDAOOracle dao = new OrderDAOOracle();
	private OrderDAOOracle() {
	}
	...
	public List<OrderInfo> findById(String orderId) throws FindException {
		...
		try {
			...
			/*
28	21/12/10	C0004	ICE라테	1500	2
27	21/12/09	C0004	ICE라테	1500	1
27	21/12/09	C0002	ICE아메리카노	1000	3
27	21/12/09	C0003	라테	1500	2
26	21/12/09	C0002	ICE아메리카노	1000	2
26	21/12/09	C0001	아메리카노	1000	1
25	21/12/09	C0002	ICE아메리카노	1000	2
25	21/12/09	C0001	아메리카노	1000	1
			 */
